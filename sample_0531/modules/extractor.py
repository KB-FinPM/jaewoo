...
각 항목 schema:
[
  {"category":"기능 | 비기능 | 인터페이스 | 데이터 | 정책","requirement_name":"요구사항명","requirement_type":"기능요구사항 | 비기능요구사항","domain":"업무영역","feature":"기능명","description":"요구사항 설명","note":"비고"}
]
규칙:
- 문서에 없는 내용은 추측하지 않는다.
...
{chunk.text}
'''
    raw = invoke_bedrock(system_prompt=EXTRACTION_SYSTEM_PROMPT, user_prompt=prompt, max_tokens=6000).strip()
