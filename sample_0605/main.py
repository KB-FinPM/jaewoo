...
def parse_args():
    ...
    parser.add_argument('--recreate-collection', action='store_true', default=RECREATE_COLLECTION, help='PgVector 테이블 재생성 여부')
    ...
    parser.add_argument('--process', default='process.json', help='산출물 생성 여부/프로젝트유형/max_token 설정 JSON 경로')
