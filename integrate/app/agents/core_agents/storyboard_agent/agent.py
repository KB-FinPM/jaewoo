...
class StoryboardAgent:
    """요구사항 RAG 결과를 기반으로 화면기획 데이터를 생성하는 Core Agent."""

    def __init__(self, store: QdrantRequirementStore):
        self.store = store

    def run(self, atoms: List[RequirementAtom], doc_key: str, purpose: str, limit_per_domain: int = 25) -> List[ScreenPlanItem]:
        ...
        return generate_screen_plan_items_from_rag(contexts)
